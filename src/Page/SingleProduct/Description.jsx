     ...
     <div className='flex flex-row pt-10 gap-3 items-center'>
          ...
          <div className='w-full'>
              <div className='flex items-center justify-between w-full'>
                <p className='flex gap-2'><p className='font-bold'>Admin</p><p className='text-gray-400'>- 20 March, 2025</p></p>
               <p>  <Stack spacing={3}>
       ...
       <div className='flex flex-row pt-10 gap-3 items-center'>
          ...
          <div className='w-full'>
              <div className='flex items-center justify-between w-full'>
                <p className='flex gap-2'><p className='font-bold'>Admin</p><p className='text-gray-400'>(verified owner) - 20 March, 2025</p></p>
               <p>  <Stack spacing={3}>
            <Rating name="half-rating" readOnly defaultValue={3} precision={0.5} />
          </Stack></p>
              </div>
...
<div className="">
{
  reviews.map((re, i)=> (
       ...
       <div key={i} className='flex flex-row pt-10 gap-3 items-center'>
          ...
          <div className='w-full'>
              <div className='flex items-center justify-between w-full'>
                <p className='flex gap-2'><p className='font-bold'>{re.name}</p><p className='text-gray-400'>{re.date}</p></p>
               <p>  <Stack spacing={3}>
