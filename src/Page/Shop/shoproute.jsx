// file import 
import ShopAllDescription from './ShopDescription';
import ShopAllRelated from './ShopReleted';


// item img 
import item from './productdata';
...
const {idd} = useParams()
const itempost = item.find(p => p.id === parseInt(idd))
     ...
     <div className="p-5 flex flex-col gap-5">
         <div className='flex flex-col gap-3'>
          ...
          <div className='flex gap-5 font-bold'>
               ...
               <p><Link to="">{itempost.rateus} {itempost.rateusPoint}</Link></p>
          </div>
          <p className='flex gap-1'><span className='font-bold text-2xl'>${itempost.price}</span><span className='line-through text-gray-300 flex justify-end items-end'>${itempost.oldprice}</span></p>
         <hr />
         <div>
