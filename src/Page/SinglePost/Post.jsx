...
<hr />
<div className='p-5'>
     <p className='pb-5 font-black text-2xl uppercase'>Leave a Reply</p>
     <p className='text-gray-500 '>Your email address will not be published. Required fields are marked *</p>
    <div className='mt-10'>
     <label htmlFor="comm" className='font-bold text-[20px]'>Comment *</label>
     <textarea name="comm" cols="30" rows="5"  id="comm" 
     className='w-full rounded-md outline-blue-400 bg-[#171717] border-0 mt-5 mb-5'></textarea>
    </div>
    <div>
       <label htmlFor="nam" className='font-bold'>Name *</label>
       <input type="text" name='nam' id='nam'
        className='w-full rounded-md outline-blue-400 bg-[#171717] border-0 mt-5 mb-5'/>
    </div>
    <div>
    ...
    <div>
     <label htmlFor="web" className='font-bold'>Website</label>
     <input type="text" name="web" id="web" 
      className='w-full rounded-md outline-blue-400 bg-[#171717] border-0 mt-5 mb-5'/>
    </div>
    <div className='flex gap-5'>
     <input type="checkbox" name="chekgg" id="chekgg" />
     <label htmlFor="chekgg" className='font-bold'>Save my name, email, and website in this browser for the next time I comment.</label>
    </div>
    <div className='mt-10'>
     <button className='bg-yellow-400 p-3 rounded-md font-bold cursor-pointer'>
          <Link to="">
          Post Comment
          </Link>
     </button>
